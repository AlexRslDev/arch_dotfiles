...
<table border="0">
 <tr>
    <td><img src="./Previews/desktop.png" alt="Desktop" width="300"></td>
    <td><img src="./Previews/fastfetch.png" alt="Fastfetch" width="300"></td>
    <td><img src="./Previews/neovim.png" alt="Neovim" width="300"></td>
 </tr>
 <tr>
    <td><img src="./Previews/qutebrowser.png" alt="Qutebrowser" width="300"></td>
    <td><img src="./Previews/nautilus.png" alt="Nautilus" width="300"></td>
    <td><img src="./Previews/yazi.png" alt="Yazi" width="300"></td>
 </tr>
</table>
...
| `:%s/old_word/new_word/` | Replace all words for another in neovim. |
| `v+selection+gc` | Comment in visual mode. |
